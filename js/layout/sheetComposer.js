(function(root){
 ...
 function composeSheet({drawingType='代表階平面図',scale='1/200',title='図面',drawingNumber='A-001',projectTitle='ホテル計画',pageNumber='1/1'}={}){
  const type=keyMap[drawingType]||drawingType; const body=type==='配置図'?{x:22,y:22,width:284,height:242}:type==='答案用紙'?{x:22,y:28,width:374,height:220}:{x:22,y:22,width:284,height:242};
