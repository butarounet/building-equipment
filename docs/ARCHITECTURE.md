...
3. Building Generatorが建築条件を生成する。
4. Equipment Generatorが設備条件を生成する。
5. Drawing Generatorが図面中間表現とSVGを生成する。
6. Exam Generatorが試験資料と問題を生成する。
7. Scoring Generatorが採点基準を生成する。
8. Quality Checkerが全体整合を確認する。
9. Output LayerがHTML、PDF、SVG、JSONとして出力する。
