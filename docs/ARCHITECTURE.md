...
7. Drawing Generatorが図面中間表現とSVGを生成する。
8. Exam Generatorが試験資料と問題を生成する。
9. Scoring Generatorが採点基準を生成する。
10. Quality Checkerが全体整合を確認する。
11. Output LayerがHTML、PDF、SVG、JSONとして出力する。
