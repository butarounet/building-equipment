...
共通仕様として原点は左上、単位はmm、A3横、20mm以上の余白、建物中央配置、右下タイトル枠、右上方位、右側または下側凡例とする。SVG座標は図面縮尺に応じて変換し、IDは壁・柱・通り芯・寸法・室名ごとに一意化する。

配置図は標準縮尺1/500で、敷地境界、道路、道路幅員、方位記号、建物外形、建物配置寸法、車寄せ、駐車場、搬入口、歩行者入口、サービス入口、屋外設備置場、緑地、受電・都市ガス・上水・下水・雨水の接続位置、縮尺、凡例を描画する。

平面図は標準縮尺1/200で、地下1階、1階、2階、3階、4〜10階代表階、塔屋、屋上を対象とする。通り芯は建物外形の外側まで延長し、X1〜X6、Y1〜Y5を基本に円形記号を上下左右へ表示する。柱は通り芯交点、外壁は200mm相当、内壁は100〜150mm相当、柱は700〜900mm相当を標準表現とする。室名は室中央付近、室面積は室名下、寸法線は建物外周外側に配置する。設備機器・配管・ダクト・配線は描画しない。

白図は平面図と同じ建築形状を使い、通り芯、柱、壁、扉、窓、階段、EV、室名、寸法、EPS、PS、DS、設備室名称、図枠、タイトル枠のみ保持する。設備機器、配管、ダクト、配線、模範解答、設備系統名称、設備記号は含めない。
